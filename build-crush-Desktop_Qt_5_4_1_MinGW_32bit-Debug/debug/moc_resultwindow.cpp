...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_resultwindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 19, 21) // "on_pushButton_clicked"
    ...
    "resultwindow\0back\0\0on_pushButton_clicked"
};
...
void resultwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (resultwindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&resultwindow::back)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject resultwindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_resultwindow.data,
...
void *resultwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_resultwindow.stringdata))
